...
--     ordenando pela duracao em ordem decrescente (Corrigindo o desafio - Ordenar pela Quantidade)
SELECT
	Ano,
	COUNT(*) AS Quantidade
FROM Filmes
...
SELECT
	...
	Atores.UltimoNome,
	ElencoFilme.Papel
FROM Atores INNER JOIN ElencoFilme ON Atores.Id = ElencoFilme.IdAtor
